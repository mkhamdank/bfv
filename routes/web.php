...
Route::group(['middleware' => ['auth'], 'namespace' => 'App\Http\Controllers'], function () {
    ...
    Route::get('po_confirmation/equipment', 'PoConfirmationController@indexPoConfirmationEquipment');
    Route::get('fetch/po_confirmation/equipment', 'PoConfirmationController@fetchPoEquipment');
    Route::post('input/po_confirmation/equipment', 'PoConfirmationController@inputPoConfirmationEquipment');
    Route::get('send/po_notification/equipment/{po_number}', 'PoConfirmationController@sendPoNotificationEquipment');
