...
use App\Http\Controllers\TestPuppeteerController;
...
Route::post('input/additional/driver/job/parking_emoney', 'App\Http\Controllers\GeneralController@inputAdditionalDriverJobParkingEmoney');
