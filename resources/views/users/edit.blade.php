...
<style>
    ...
    .header-left h1 span { color: #c9c6f0; }
    ...
    .field-hint { font-size: 11px; color: #b0aece; margin-top: 5px; display: flex; align-items: center; gap: 5px; }
...
<div style="padding-bottom: 10px;">
    ...
    <div class="page-header-modern">
        <div class="header-left">
            ...
            <h1>Edit User <span>/ {{ $user->username }}</span></h1>
            <div class="user-chip">
                ...
                <div class="col-md-6" style="padding-right: 32px; border-right: 1px solid #f0eef9;">
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-hint">
                            <i class="fas fa-info-circle"></i> Kosongkan field ini jika tidak ingin mengubah password.
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#btn-save-user').click(function () {
            ...
            if (!username || !name || !email) {
                alert('Harap lengkapi field username, nama, dan email.');
                return false;
            }
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status === 'success') {
                        alert(data.message || 'User berhasil diperbarui.');
                        setTimeout(function () {
    ...
    function renderUserPermission() {
        var userPermission = {!! json_encode($user->permissions->toArray()) !!};
        $.each(userPermission, function (key, value) {
            $('#permission input[value="' + value.id + '"]').prop('checked', true);
        });
    }
