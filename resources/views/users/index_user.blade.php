...
<style>
    ...
    .um-menu-btn:hover .btn-icon { transform: scale(1.08); }

    .btn-icon.purple { background: #ede9fe; color: #7c3aed; }
    .btn-icon.blue   { background: #ebf2ff; color: #2d6bc4; }
    .btn-icon.slate  { background: #f1f5f9; color: #475569; }

    .um-menu-btn .btn-content { flex: 1; min-width: 0; }
    .um-menu-btn .btn-content .btn-title {
        display: block;
        font-size: 14px;
        font-weight: 700;
        color: inherit;
    ...
    .um-menu-btn .btn-content .btn-desc {
        display: block;
        font-size: 12px;
        font-weight: 400;
        color: #718096;
    ...
    .um-menu-btn:hover .btn-content .btn-desc { color: #7c6fd0; }

    .um-menu-btn .btn-arrow {
        font-size: 12px;
        color: #c4c1e0;
        flex-shrink: 0;
        transition: transform .2s, color .2s;
    }
    .um-menu-btn:hover .btn-arrow {
...
<div class="container-fluid" style="padding: 0 24px;">
    ...
    <div class="page-header-modern">
        <div class="header-left">
            ...
            <p>Kelola data pengguna, hak akses, dan pengaturan sistem</p>
        </div>
    </div>
    ...
    <div class="menu-card">
        ...
        <div class="menu-card-body">
            ...
            {{-- User --}}
            <a href="{{ route('admin.user.index') }}" class="um-menu-btn">
                <div class="btn-icon purple">
                    <i class="fas fa-user"></i>
                </div>
                <div class="btn-content">
                    <span class="btn-title">User Management</span>
                    <span class="btn-desc">Kelola daftar akun pengguna aplikasi</span>
                </div>
                <i class="fas fa-chevron-right btn-arrow"></i>
            </a>

            {{-- User Permission --}}
            <a href="{{ route('admin.permission.index') }}" class="um-menu-btn">
                <div class="btn-icon blue">
                    <i class="fas fa-user-cog"></i>
                </div>
                <div class="btn-content">
                    <span class="btn-title">User Permission</span>
                    <span class="btn-desc">Atur hak akses dan role setiap pengguna</span>
                </div>
                <i class="fas fa-chevron-right btn-arrow"></i>
            </a>

            {{-- Setting --}}
            <a href="{{ route('admin.settings.index') }}" class="um-menu-btn">
                <div class="btn-icon slate">
                    <i class="fas fa-cog"></i>
                </div>
                <div class="btn-content">
                    <span class="btn-title">Setting</span>
                    <span class="btn-desc">Konfigurasi dan pengaturan umum sistem</span>
                </div>
                <i class="fas fa-chevron-right btn-arrow"></i>
            </a>
