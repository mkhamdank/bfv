                        ...
                        if (result.driver_job[i].times == null) {
                            if(result.driver_job[i].remark == 'japanese'){
                                ...
                                for(var j = 0; j < result.base64id.length;j++){
                                    if(result.base64id[j].id == result.driver_job[i].id){
                                        base64id = result.base64id[j].base64id;
                                    }
                                }
                                divDriver += '<div class="col-md-3" style="padding: 5px; cursor: pointer; background-color: #fff1c2; margin-bottom: 10px;" onclick="closureJob(\''+result.driver_job[i].id+'\',\''+base64id+'\')">';
                            }else{
