    ...
    <div class="container-contact100" style="align-items: start">
        <div class="wrap-contact100 col-xs-12 col-md-8 col-md-offset-2" style="padding: 0 10px; padding-bottom: 3%;">
            <span class="contact100-form-title" id="main-title">
                PT. YMPI<br>VENDOR CONFIRMATION
            </span>
            ...
            <div id="not_filled" style="width: 100%;">
                ...
                <div class="col-xs-12 col-md-12" id="main" style="vertical-align: middle; margin-top: 3%;">
                    <p style="color:black">Dear {{ ucwords(strtolower($data->vendor_name)) }}</p>
                    <br>
                    @if($data->country == 'ID')
                    <p style="color:black">
                        Kami mengucapkan terima kasih yang sebesar-besarnya atas konfirmasi dan pemahaman terhadap kebijakan perusahaan kami, dan kami berharap dapat terus menjalin hubungan bisnis yang transparan, adil, dan saling menguntungkan di masa depan.
                    </p>
