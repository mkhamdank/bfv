...
<style>
    ...
    .btn-icon.green  { background: #ede9fe; color: #7c3aed; }
...
<div class="container-fluid" style="padding: 0 24px;">
    ...
    <div class="page-header-modern">
        <div class="header-left">
            ...
            <p>Kelola proses rekrutmen dan sumber daya manusia perusahaan</p>
        </div>
    </div>
    ...
    <div class="menu-card">
        ...
        <div class="menu-card-body">
            ...
            {{-- Recruitment --}}
            <a href="{{ url('/index/ympi_recruitment_monitoring') }}" class="mol-menu-btn">
                <div class="btn-icon green">
                    <i class="fas fa-user-circle"></i>
                </div>
                <div class="btn-content">
                    <span class="btn-title">Recruitment</span>
                    <span class="btn-desc">Pantau dan kelola proses rekrutmen karyawan</span>
                </div>
