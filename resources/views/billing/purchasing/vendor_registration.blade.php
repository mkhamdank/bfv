        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label for="alasan_reject" class="control-label">Input Reason (Reject User) : <span class="text-red">*</span></label>

                    <textarea name="alasan_reject" id="alasan_reject" cols="30" rows="10" class="form-control"></textarea>
                ...
                <div class="modal-footer">
                    ...
                    <a id="a" name="modalButtonReject" type="button"  onclick="deleteUser(this.id)" class="btn btn-danger" style="color:white">Reject</a>
                </div>
            </div>
        </div>
